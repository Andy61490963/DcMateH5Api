...
public class FormControllerRouteContractTests
{
    ...
    [InlineData(typeof(FormDesignerMultipleMappingController), 18)]
    [InlineData(typeof(FormDesignerTableValueFunctionController), 12)]
    [InlineData(typeof(FormMasterDetailController), 3)]
    [InlineData(typeof(FormMultipleMappingController), 9)]
    ...
    [InlineData(typeof(FormDesignerMultipleMappingController), "GetMappingComponents", "POST", "{formMasterId:guid}/mapping-components/query")]
    [InlineData(typeof(FormDesignerMultipleMappingController), "UpsertMappingComponent", "PUT", "{formMasterId:guid}/mapping-components/{mappingRowId}")]
    [InlineData(typeof(FormDesignerMultipleMappingController), "DeleteMappingComponent", "DELETE", "{formMasterId:guid}/mapping-components/{mappingRowId}")]
    [InlineData(typeof(FormMultipleMappingController), "UpdateMappingComponentValue", "PUT", "{formMasterId:guid}/mapping-components/{mappingRowId}/value")]
